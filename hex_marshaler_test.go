...
func TestHexMarshaler_Marshal_md5(t *testing.T) {
	h := MD5Hasher{Iter: &iter, Salt: &salt}
	h.SetPassword(password)
	s, err := m.Marshal(&h)
	assert.Nil(t, err)
...
func TestHexMarshaler_Marshal_sha1(t *testing.T) {
	h := SHA1Hasher{Iter: &iter, Salt: &salt}
	h.SetPassword(password)
	s, err := m.Marshal(&h)
	assert.Nil(t, err)
...
func TestHexMarshaler_Marshal_sha224(t *testing.T) {
	h := SHA224Hasher{Iter: &iter, Salt: &salt}
	h.SetPassword(password)
	s, err := m.Marshal(&h)
	assert.Nil(t, err)
...
func TestHexMarshaler_Marshal_sha256(t *testing.T) {
	h := SHA256Hasher{Iter: &iter, Salt: &salt}
	h.SetPassword(password)
	s, err := m.Marshal(&h)
	assert.Nil(t, err)
...
func TestHexMarshaler_Marshal_sha384(t *testing.T) {
	h := SHA384Hasher{Iter: &iter, Salt: &salt}
	h.SetPassword(password)
	s, err := m.Marshal(&h)
	assert.Nil(t, err)
...
func TestHexMarshaler_Marshal_sha512_224(t *testing.T) {
	h := SHA512_224Hasher{Iter: &iter, Salt: &salt}
	h.SetPassword(password)
	s, err := m.Marshal(&h)
	assert.Nil(t, err)
...
func TestHexMarshaler_Marshal_sha512_256(t *testing.T) {
	h := SHA512_256Hasher{Iter: &iter, Salt: &salt}
	h.SetPassword(password)
	s, err := m.Marshal(&h)
	assert.Nil(t, err)
